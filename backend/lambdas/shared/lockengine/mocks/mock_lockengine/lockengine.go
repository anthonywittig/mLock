...
//
//	mockgen -source=lockengine.go -destination mocks/mock_lockengine/lockengine.go
//
...
func (mr *MockDeviceControllerMockRecorder) AddLockCode(ctx, device, code any) *gomock.Call {
...
func (mr *MockDeviceControllerMockRecorder) RemoveLockCode(ctx, device, code any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDeviceRepositoryMockRecorder) AppendToAuditLog(ctx, device, managedLockCodes any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDeviceRepositoryMockRecorder) ListActive(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDeviceRepositoryMockRecorder) Put(ctx, item any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEmailServiceMockRecorder) SendEmailToDevelopers(ctx, subject, body any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
