...
//
//	mockgen -source=scheduler.go -destination mocks/mock_scheduler/scheduler.go
//
...
func (mr *MockReservationRepositoryMockRecorder) GetForUnits(ctx, units any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// List indicates an expected call of List.
func (mr *MockUnitRepositoryMockRecorder) List(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
