...
type HABThing struct {
	Channels      []HABThingChannel `json:"channels"`
...
func (h *HABThing) GetBatteryChannel() *HABThingChannel {
	// WARNING: assumes there is only one battery level channel.
...
OpenHAB things:
{
    ...
    --"statusInfo": {
        --"status": "ONLINE",
        --"statusDetail": "NONE",
        --"description": "Node initialising: REQUEST_NIF"
    },
