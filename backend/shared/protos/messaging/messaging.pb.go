...
func (x *OnPremResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OnPremResponse) ProtoMessage() {}

func (x *OnPremResponse) ProtoReflect() protoreflect.Message {
	mi := &file_protos_messaging_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OnPremResponse.ProtoReflect.Descriptor instead.
func (*OnPremResponse) Descriptor() ([]byte, []int) {
	return file_protos_messaging_proto_rawDescGZIP(), []int{2}
}

func (x *OnPremResponse) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
var file_protos_messaging_proto_rawDesc = []byte{
	...
	0x6e, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x56, 0x0a, 0x0a, 0x48, 0x61, 0x62, 0x43,
	...
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x26, 0x0a, 0x07, 0x72, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x48, 0x54, 0x54, 0x50,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x22, 0x39, 0x0a, 0x0b, 0x48, 0x54, 0x54, 0x50, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x22, 0x32, 0x0a, 0x0e, 0x4f,
	0x6e, 0x50, 0x72, 0x65, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x20, 0x0a,
	...
	0x0c, 0x5a, 0x0a, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x62, 0x06, 0x70,
...
var file_protos_messaging_proto_goTypes = []interface{}{
	(*HabCommand)(nil),     // 0: HabCommand
	(*HTTPRequest)(nil),    // 1: HTTPRequest
	(*OnPremResponse)(nil), // 2: OnPremResponse
}
var file_protos_messaging_proto_depIdxs = []int32{
	1, // 0: HabCommand.request:type_name -> HTTPRequest
