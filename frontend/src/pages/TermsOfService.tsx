  ...
  return (
    <div>
      ...
      <p>
        ...
        carefully before using {process.env.REACT_APP_BACKEND_DOMAIN || ""}{" "}
        website (the "service") operated by Anthony Wittig ("us", 'we", "our").
      </p>
      ...
      <p>
        ...
        <a href="/privacy-policy">privacy policy</a> regarding our user data
        collection.
      </p>
      ...
      <p>
        ...
        graphics, logos) is our property of and/or its content creators and
        protected by international copyright laws. The entire compilation of the
        content found on this website is our exclusive property, with copyright
        authorship for this compilation.
      </p>
      ...
      <p>
        ...
        of service, or any dispute of any sort that might come between us and
      ...
      <p>
        ...
        court of the state of Utah or the United States and you consent to
      ...
      <p>
        ...
        such content. When you post your content, you grant us non-exclusive,
